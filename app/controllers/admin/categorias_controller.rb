...
class CategoriasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categoria.save
        format.html { redirect_to ['admin',@categoria], notice: 'Categoria was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @categoria.update(categoria_params)
        format.html { redirect_to ['admin', @categoria], notice: 'Categoria was successfully updated.' }
